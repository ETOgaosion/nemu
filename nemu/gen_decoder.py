...
if ARCH == 'riscv64':
    ...
    sorted_inst_type = {}
    for key in count:
        if not inst_type[key] in sorted_inst_type:
            sorted_inst_type[inst_type[key]] = [key]
        else:
            sorted_inst_type[inst_type[key]].append(key)
    
    print(sorted_inst_type)

void handle_add_sub_mul(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
...
void handle_sll_mulh(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
...
void handle_slt_mulhsu(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_1) {
...
void handle_sltu_mulhu(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_1) {
...
void handle_xor_div(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_1) {
...
void handle_srl_sra_divu(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_6) {
...
void handle_or_rem(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_1) {
...
void handle_and_remu(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_1) {
...
void handle_addw_subw_mulw(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_6) {
...
void handle_srlw_sraw_divuw(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_6) {
...
void handle_srli_srai(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_6) {
...
void handle_srliw_sraiw(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
    if (inst & FRONTCODE7_6) {
...
void handle_ecall_ebreak_sret_mret(Decode *s, uint32_t inst, int *rd, int *rs1, int *rs2, int64_t *imm) {
